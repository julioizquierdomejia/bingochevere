                ...
                <div class="card bg-secondary shadow">
                    <div class="card-header bg-white border-0">
                        <div class="row align-items-center">
                            <h3 class="mb-0">{{ __('CREAR CLIENTE') }}</h3>
                        </div>
                    </div>
                    <div class="card-body">
                        <form method="post" action="{{ route('admin.clients.store') }}" autocomplete="off" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="pl-lg-4">
                                <div class="form-group{{ $errors->has('name') ? ' has-danger' : '' }}">
                                    ...
                                    <input type="text" name="name" id="input-name" class="form-control form-control-alternative{{ $errors->has('name') ? ' is-invalid' : '' }}" placeholder="{{ __('Razon Social del Cliente') }}" value="{{ old('name') }}"autofocus>
                                ...
                                <div class="form-group{{ $errors->has('nombre_comercial') ? ' has-danger' : '' }}">
                                    ...
                                    <input type="text" name="nombre_comercial" id="input-nombre_comercial" class="form-control form-control-alternative{{ $errors->has('nombre_comercial') ? ' is-invalid' : '' }}" placeholder="{{ __('Nombre comercial de la empresa') }}" value="{{ old('nombre_comercial') }}">
                                ...
                                <div class="form-group{{ $errors->has('ruc') ? ' has-danger' : '' }}">
                                    ...
                                    <input type="text" name="ruc" id="input-ruc" class="form-control form-control-alternative{{ $errors->has('ruc') ? ' is-invalid' : '' }}" placeholder="{{ __('RUC') }}" value="{{ old('ruc') }}">
                                ...
                                <div class="form-group{{ $errors->has('contacto') ? ' has-danger' : '' }}">
                                    ...
                                    <input type="text" name="contacto" id="input-contacto" class="form-control form-control-alternative{{ $errors->has('contacto') ? ' is-invalid' : '' }}" placeholder="{{ __('Nombre de la Persona de contacto') }}" value="{{ old('contacto') }}">
                                ...
                                <div class="form-group{{ $errors->has('area') ? ' has-danger' : '' }}">
                                    ...
                                    <input type="text" name="area" id="input-area" class="form-control form-control-alternative{{ $errors->has('area') ? ' is-invalid' : '' }}" placeholder="{{ __('Area del contacto') }}" value="{{ old('area') }}">
                                ...
                                <div class="form-group{{ $errors->has('telefono') ? ' has-danger' : '' }}">
                                    ...
                                    <input type="text" name="telefono" id="input-telefono" class="form-control form-control-alternative{{ $errors->has('telefono') ? ' is-invalid' : '' }}" placeholder="{{ __('Area del contacto') }}" value="{{ old('telefono') }}">
