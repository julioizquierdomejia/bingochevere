                    ...
                    <div class="col-xl-3 col-lg-6">
                        <div class="card card-stats mb-4 mb-xl-0">
                            <div class="card-body">
                                <div class="row">
                                    <div class="col">
                                        <h5 class="card-title text-uppercase text-muted mb-0">Campañas Activas</h5>
...
@if($user_current->role_id == 2) {{-- si es Cliente --}}
    <div class="header bg-gradient-primary pb-8 pt-5 pt-md-8">
        <div class="container-fluid">
            <div class="header-body">
                <!-- Card stats -->
                    ...
                    <div class="col">
                        ...
                        @if($carton == null)
                            <p class="" style="font-size: 20px; font-weight: bold; color:{{$campania->color_text}}">
                                ...
                                <br>
                                Para ello te invitamos a que generes tu cartón de Bingo y
                                <br>
